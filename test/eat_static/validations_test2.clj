...
(deftest blended-overrides
  (is (eval '(blend anilx [[a nil]] vt/a9b8)))
  (is (= {:a 9 :b 8} (eval '(d anilx))))
  ...
  (is (eval '(blend a1b8x [[a 1]] aRb8)))
  (is (= {:a 1 :b 8} (eval '(d a1b8x))))
